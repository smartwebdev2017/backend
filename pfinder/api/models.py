...
class BSF(models.Model):
    ...
    model_year = models.IntegerField(max_length=4, db_index=True)
...
class PCF(models.Model):
    ...
    model_number = models.CharField(max_length=5, null=True, blank=True, db_index=True)
    vid = models.CharField(max_length=6, db_index=True)
...
class Car(models.Model):
    ...
    vin_code = models.CharField(max_length=17, null=True, blank=True, db_index=True)
    ...
    listing_model_detail = models.CharField(max_length=30, null=True, blank=True, db_index=True)
    listing_year = models.IntegerField(max_length=4, null=True, blank=True, db_index=True)
    ...
    listing_transmission = models.CharField(max_length=15, null=True, blank=True, db_index=True)
    listing_transmission_detail = models.CharField(max_length=255, null=True, blank=True)
    listing_title = models.CharField(max_length=255, null=True, blank=True, db_index=True)
