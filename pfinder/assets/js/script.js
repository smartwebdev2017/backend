...
(function() {
  ...
  app = angular.module('pfinder.app.editor', ['pfinder.api', 'pfinder.app.photos']);
...
(function() {
  ...
  app = angular.module('pfinder.app.playground', ['pfinder.api.playground']);
...
(function() {
  ...
  app = angular.module('pfinder.app.static', []);
...
(function() {
  ...
  app = angular.module('pfinder.app.update', ['pfinder.api']);
...
(function() {
  ...
  app = angular.module('pfinder.api', ['ngResource']);
...
(function() {
  ...
  app = angular.module('pfinder.api.playground', []);
