...
DATABASES = {
    'default': {
        ...
        'NAME': 'pfinder',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'dev',
        'PASSWORD': 'pfinder',
        'HOST': '35.192.81.142',                      # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
